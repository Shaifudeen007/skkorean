...
const ProductDetail = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen pt-32 pb-20 flex items-center justify-center text-foreground">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-medium w-fit">
              <Zap className="w-4 h-4" /> {product.category?.name || product.category || 'Uncategorized'}
            </div>
            ...
            {(product.discountPrice || product.mrp) && (
              <div className="flex items-center gap-4 mb-6">
                {product.mrp && (
                  <span className="text-xl sm:text-2xl text-foreground/50 line-through">
                    ₹{product.mrp}
                  </span>
                )}
            ...
            <ul className="text-lg text-foreground/70 mb-8 leading-relaxed list-disc pl-5 space-y-2">
